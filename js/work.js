...
const productList = [
    ...
    },
    {
        id: 4,
        name: "Components",
        img: "https://res.cloudinary.com/fashsion-brand/image/upload/v1654602680/Rectangle_40_h3h393.png",
        time: 2018,
        content: "Typography",
        type: "Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.",
    },
    ...
    for(let i = 0; i< products.length; i++){
        ...
        <div class="grid md:grid-cols-[246px,auto] gap-8 border-b py-8">
          <div class="" >
             ...
             <img class ="w-full md:w-[246px] hover:border-4 hover:border-blue-400 hover:rounded-xl" src="${product.img}">
             </a>
          </div>
